	...
	public void run() {
		...
		while (estado != -1) {
			...
			case 1:
				...
				j2.setNombre(j2.getSocket().readLine().split(" ")[1]);
				estado = 2;
				break;
			
			case 2:
				System.out.println("Preguntando apuestas...");
				System.out.println(j1.getSocket() + " ||| " + j1.getNombre());
				System.out.println(j2.getSocket() + " ||| " + j2.getNombre());
				if (j1.getSocket() == j2.getSocket())
